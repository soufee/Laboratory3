 ...
 * generated in the main.essences package.
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: main.essences
     * 
     */
     ...
     * 
     */
    public Gamer createGamer(String name, String password, String email, boolean isAdmin) {
      Gamer gamer = new Gamer();
      gamer.setNiackname(name);
      gamer.setPassword(password);
      gamer.setEmail(email);
      gamer.setScore(0);
      gamer.setAdmin(isAdmin);
